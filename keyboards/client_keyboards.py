...
def start_markup(lang='ru'):
    mattresses_btn = {
        ...
        'kg': KeyboardButton('Матрастар \U0001F6CF'),
    ...
    about_us_btn = {
        ...
        'kg': KeyboardButton('Биз жонундо  \U0001F4F0'),
    ...
    social_media_btn = {
        ...
        'kg': KeyboardButton('Мы в социальных сетях \U0001F4E8'),
    ...
    receive_notifications_btn = {
        ...
        'kg': KeyboardButton('Получать сообщения о скидках \U0001F523'),
    }
...
def mattresses_catalog(lang='ru'):
    ...
    all_mattresses = {
        ...
        'kg': InlineKeyboardButton('Общий матрастар \U0001F30D',         callback_data='category_all'),
    }
    big_discount_mattresses = {
        ...
        'kg': InlineKeyboardButton('Матрасы со скидками \U0001F4B2', callback_data='category_dsc'),
    }
    cheap_mattresses = {
        ...
        'kg': InlineKeyboardButton('Недорогие матрасы \U0001F495',   callback_data='category_chp'),
    }
    heavy_mattresses = {
        ...
        'kg': InlineKeyboardButton('Для тяжёлых людей \U0001F62C',   callback_data='category_hvy'),
    }
    hard_mattresses = {
        ...
        'kg': InlineKeyboardButton('Жёсткие матрасы \U0001F5FF',     callback_data='category_hrd'),
    }
    soft_mattresses = {
        ...
        'kg': InlineKeyboardButton('Мягкие матрасы \U0001F607',      callback_data='category_sft'),
    }
    kid_mattresses = {
        ...
        'kg': InlineKeyboardButton('Детские матрасы \U0001F476',     callback_data='category_kid'),
    }
...
def product_inline_keyboard(product_name: str, lang='ru'):
    place_order = {
        ...
        'kg': InlineKeyboardButton('Оформить заказ', callback_data=f'choose_{product_name}'),
    }
    ...
    text_manager = {
        ...
        'kg': InlineKeyboardButton('Написать консультанту', url='https://t.me/toktokozhoev'),
    }
...
def website_inline_keyboard(lang='ru'):
    website_link_button = {
        ...
        'kg': InlineKeyboardButton('saitka otuu', url='https://www.ormatt.kg/'),
    }
...
def leave_a_review_cancel(lang='ru'):
    cancel = {
        'ru': KeyboardButton('RU Cancel \U0001F555'),
        'en': KeyboardButton('EN Cancel \U0001F555'),
        'kg': KeyboardButton('KG cancel \U0001F555'),
    }
    return ReplyKeyboardMarkup(resize_keyboard=True).add(cancel[lang])

def cancel_buy_markup(lang='ru'):
    cancel = {
        'ru': KeyboardButton('RU Cancel \U0001F554'),
        'en': KeyboardButton('EN Cancel \U0001F554'),
        'kg': KeyboardButton('KG cancel \U0001F554'),
    }
    return ReplyKeyboardMarkup(resize_keyboard=True).add(cancel[lang])

def phone_number_buy_markup(lang='ru'):
    text = {
        'ru': KeyboardButton('RU SEND PHONE NUMBER', request_contact=True),
        'en': KeyboardButton('Send my phone number', request_contact=True),
        'kg': KeyboardButton('KG SEND PHONE NUMBER', request_contact=True),
    }
